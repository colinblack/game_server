...
void protobuf_AssignDesc_DataCommon_2eproto() {
  ...
  static const int BaseItemCPP_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BaseItemCPP, powerts_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BaseItemCPP, onhookcoints_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BaseItemCPP, onhookexpts_),
  };
  ...
  static const int CommonItemsCPP_offsets_[2] = {
...
void protobuf_AddDesc_DataCommon_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "otalValue\030\003 \002(\004\022\017\n\007powerTs\030\004 \001(\r\022\024\n\014Onho"
    "okCoinTs\030\005 \001(\r\022\023\n\013OnhookExpTs\030\006 \001(\r\">\n\021U"
    "serBaseChangeCPP\022)\n\010baseItem\030\001 \003(\0132\027.Dat"
    "aCommon.BaseItemCPP\"<\n\014PropsItemCPP\022\n\n\002u"
    "d\030\001 \002(\r\022\017\n\007propsId\030\002 \002(\r\022\017\n\007itemCnt\030\003 \002("
    "\r\"I\n\016PropsChangeCPP\022\016\n\006change\030\001 \002(\005\022\'\n\005p"
    "rops\030\002 \002(\0132\030.DataCommon.PropsItemCPP\"B\n\021"
    "PropsAllChangeCPP\022-\n\tpropsitem\030\001 \003(\0132\032.D"
    "ataCommon.PropsChangeCPP\"o\n\016CommonItemsC"
    "PP\022/\n\010userbase\030\001 \001(\0132\035.DataCommon.UserBa"
    "seChangeCPP\022,\n\005props\030\002 \001(\0132\035.DataCommon."
    "PropsAllChangeCPP", 537);
...
const int BaseItemCPP::kPowerTsFieldNumber;
const int BaseItemCPP::kOnhookCoinTsFieldNumber;
const int BaseItemCPP::kOnhookExpTsFieldNumber;
#endif  // !_MSC_VER
...
const BaseItemCPP& BaseItemCPP::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_DataCommon_2eproto();  return *default_instance_;
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_powerTs;
        break;
      }
      
      // optional uint32 powerTs = 4;
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_powerTs:
        ...
        if (input->ExpectTag(40)) goto parse_OnhookCoinTs;
        break;
      }
      
      // optional uint32 OnhookCoinTs = 5;
      case 5: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_OnhookCoinTs:
        ...
        if (input->ExpectTag(48)) goto parse_OnhookExpTs;
        break;
      }
      
      // optional uint32 OnhookExpTs = 6;
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_OnhookExpTs:
...
void BaseItemCPP::SerializeWithCachedSizes(
  ...
  // optional uint32 powerTs = 4;
  if (has_powerts()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->powerts(), output);
  }
  
  // optional uint32 OnhookCoinTs = 5;
  if (has_onhookcoints()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(5, this->onhookcoints(), output);
  }
  
  // optional uint32 OnhookExpTs = 6;
  if (has_onhookexpts()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(6, this->onhookexpts(), output);
  }
...
::google::protobuf::uint8* BaseItemCPP::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 powerTs = 4;
  if (has_powerts()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->powerts(), target);
  }
  
  // optional uint32 OnhookCoinTs = 5;
  if (has_onhookcoints()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(5, this->onhookcoints(), target);
  }
  
  // optional uint32 OnhookExpTs = 6;
  if (has_onhookexpts()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(6, this->onhookexpts(), target);
  }
...
void BaseItemCPP::Swap(BaseItemCPP* other) {
  if (other != this) {
    ...
    std::swap(powerts_, other->powerts_);
...
bool UserBaseChangeCPP::IsInitialized() const {
  ...
  for (int i = 0; i < baseitem_size(); i++) {
    if (!this->baseitem(i).IsInitialized()) return false;
  }
  return true;
}
...
bool PropsAllChangeCPP::IsInitialized() const {
  ...
  for (int i = 0; i < propsitem_size(); i++) {
    if (!this->propsitem(i).IsInitialized()) return false;
  }
  return true;
}
