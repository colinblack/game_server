...
void protobuf_AssignDesc_Stages_2eproto() {
  ...
  static const int AllStage_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AllStage, propsid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AllStage, dragon_),
...
void protobuf_AddDesc_Stages_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\002 \002(\r\022\r\n\005npcId\030\003 \003(\r\022\017\n\007propsId\030\004 \003(\r\022\036\n"
    "\006dragon\030\005 \003(\0132\016.Stages.Dragon\0223\n\007rewards"
    "\030\006 \002(\0132\".CommonGiftConfig.CommonModifyIt"
    "em\022\017\n\007heroExp\030\007 \002(\r\"-\n\nStagesInfo\022\037\n\005sta"
    "ge\030\001 \003(\0132\020.Stages.AllStage", 306);
...
const int AllStage::kPropsIdFieldNumber;
const int AllStage::kDragonFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(32)) goto parse_propsId;
        if (input->ExpectTag(42)) goto parse_dragon;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_heroExp;
        break;
      }
...
void AllStage::SerializeWithCachedSizes(
  ...
  // repeated .Stages.Dragon dragon = 5;
  for (int i = 0; i < this->dragon_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, this->dragon(i), output);
  }
  ...
  // required uint32 heroExp = 7;
  if (has_heroexp()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(7, this->heroexp(), output);
  }
...
::google::protobuf::uint8* AllStage::SerializeWithCachedSizesToArray(
  ...
  // required uint32 heroExp = 7;
  if (has_heroexp()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(7, this->heroexp(), target);
  }
...
void AllStage::MergeFrom(const AllStage& from) {
  ...
  dragon_.MergeFrom(from.dragon_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_id()) {
      set_id(from.id());
    }
...
bool AllStage::IsInitialized() const {
  ...
  for (int i = 0; i < dragon_size(); i++) {
    if (!this->dragon(i).IsInitialized()) return false;
  }
  if (has_rewards()) {
