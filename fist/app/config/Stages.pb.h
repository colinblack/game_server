...
class AllStage : public ::google::protobuf::Message {
 public:
  ...
  // repeated .Stages.Dragon dragon = 5;
  inline int dragon_size() const;
  inline void clear_dragon();
  static const int kDragonFieldNumber = 5;
  inline const ::Stages::Dragon& dragon(int index) const;
  inline ::Stages::Dragon* mutable_dragon(int index);
  inline ::Stages::Dragon* add_dragon();
  inline const ::google::protobuf::RepeatedPtrField< ::Stages::Dragon >&
      dragon() const;
  inline ::google::protobuf::RepeatedPtrField< ::Stages::Dragon >*
      mutable_dragon();
  
  // required .CommonGiftConfig.CommonModifyItem rewards = 6;
  ...
  // required uint32 heroExp = 7;
  inline bool has_heroexp() const;
  inline void clear_heroexp();
  static const int kHeroExpFieldNumber = 7;
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::Stages::Dragon > dragon_;
...
// repeated uint32 propsId = 4;
inline int AllStage::propsid_size() const {
  return propsid_.size();
}
inline void AllStage::clear_propsid() {
  propsid_.Clear();
}
inline ::google::protobuf::uint32 AllStage::propsid(int index) const {
  return propsid_.Get(index);
}
inline void AllStage::set_propsid(int index, ::google::protobuf::uint32 value) {
  propsid_.Set(index, value);
}
inline void AllStage::add_propsid(::google::protobuf::uint32 value) {
  propsid_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
AllStage::propsid() const {
  return propsid_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
AllStage::mutable_propsid() {
  return &propsid_;
}

// repeated .Stages.Dragon dragon = 5;
inline int AllStage::dragon_size() const {
  return dragon_.size();
}
inline void AllStage::clear_dragon() {
  dragon_.Clear();
}
inline const ::Stages::Dragon& AllStage::dragon(int index) const {
  return dragon_.Get(index);
}
inline ::Stages::Dragon* AllStage::mutable_dragon(int index) {
  return dragon_.Mutable(index);
}
inline ::Stages::Dragon* AllStage::add_dragon() {
  return dragon_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::Stages::Dragon >&
AllStage::dragon() const {
  return dragon_;
}
inline ::google::protobuf::RepeatedPtrField< ::Stages::Dragon >*
AllStage::mutable_dragon() {
  return &dragon_;
}
