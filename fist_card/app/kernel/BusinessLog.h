...
#define POWER_LOG(fmt,args...) CBusinessLogHelper::GetInstance("power")->Log(fmt,##args)
#define CARDS_LOG(fmt,args...) CBusinessLogHelper::GetInstance("cards")->Log(fmt,##args)
