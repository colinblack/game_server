...
// repeated .Cards.Card cards = 6;
inline int User::cards_size() const {
  return cards_.size();
}
inline void User::clear_cards() {
  cards_.Clear();
}
inline const ::Cards::Card& User::cards(int index) const {
  return cards_.Get(index);
}
inline ::Cards::Card* User::mutable_cards(int index) {
  return cards_.Mutable(index);
}
inline ::Cards::Card* User::add_cards() {
  return cards_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::Cards::Card >&
User::cards() const {
