...
class BuyHeroResp : public ::google::protobuf::Message {
 public:
  ...
  inline const ::ProtoCards::CardsAllChangeCPP& cards() const;
  inline ::ProtoCards::CardsAllChangeCPP* mutable_cards();
  inline ::ProtoCards::CardsAllChangeCPP* release_cards();
  ...
  static const int kPayFieldNumber = 4;
  inline const ::DataCommon::CommonItemsCPP& pay() const;
  inline ::DataCommon::CommonItemsCPP* mutable_pay();
  inline ::DataCommon::CommonItemsCPP* release_pay();
 ...
 private:
  ...
  ::ProtoCards::CardsAllChangeCPP* cards_;
  ::DataCommon::CommonItemsCPP* commons_;
  ::DataCommon::CommonItemsCPP* pay_;
...
// required .ProtoCards.CardsAllChangeCPP cards = 2;
inline bool BuyHeroResp::has_cards() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void BuyHeroResp::set_has_cards() {
  _has_bits_[0] |= 0x00000002u;
}
inline void BuyHeroResp::clear_has_cards() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void BuyHeroResp::clear_cards() {
  if (cards_ != NULL) cards_->::ProtoCards::CardsAllChangeCPP::Clear();
  clear_has_cards();
}
inline const ::ProtoCards::CardsAllChangeCPP& BuyHeroResp::cards() const {
  return cards_ != NULL ? *cards_ : *default_instance_->cards_;
}
inline ::ProtoCards::CardsAllChangeCPP* BuyHeroResp::mutable_cards() {
  set_has_cards();
  if (cards_ == NULL) cards_ = new ::ProtoCards::CardsAllChangeCPP;
  return cards_;
}
inline ::ProtoCards::CardsAllChangeCPP* BuyHeroResp::release_cards() {
  clear_has_cards();
  ::ProtoCards::CardsAllChangeCPP* temp = cards_;
  cards_ = NULL;
  return temp;
}
...
// optional .DataCommon.CommonItemsCPP pay = 4;
inline bool BuyHeroResp::has_pay() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void BuyHeroResp::set_has_pay() {
  _has_bits_[0] |= 0x00000008u;
}
inline void BuyHeroResp::clear_has_pay() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void BuyHeroResp::clear_pay() {
  if (pay_ != NULL) pay_->::DataCommon::CommonItemsCPP::Clear();
  clear_has_pay();
}
inline const ::DataCommon::CommonItemsCPP& BuyHeroResp::pay() const {
  return pay_ != NULL ? *pay_ : *default_instance_->pay_;
}
inline ::DataCommon::CommonItemsCPP* BuyHeroResp::mutable_pay() {
  set_has_pay();
  if (pay_ == NULL) pay_ = new ::DataCommon::CommonItemsCPP;
  return pay_;
}
inline ::DataCommon::CommonItemsCPP* BuyHeroResp::release_pay() {
  clear_has_pay();
  ::DataCommon::CommonItemsCPP* temp = pay_;
  pay_ = NULL;
  return temp;
}
