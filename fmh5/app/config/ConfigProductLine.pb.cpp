...
const EquipLine& EquipLine::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ConfigProductLine_2eproto();  return *default_instance_;
}
...
bool EquipLine::IsInitialized() const {
  ...
  for (int i = 0; i < queue_price_size(); i++) {
    if (!this->queue_price(i).IsInitialized()) return false;
  }
  return true;
}
...
bool FruitLine::IsInitialized() const {
  ...
  for (int i = 0; i < stage_product_size(); i++) {
    if (!this->stage_product(i).IsInitialized()) return false;
  }
  return true;
}
...
bool MaterailReward::IsInitialized() const {
  ...
  for (int i = 0; i < random_reward_size(); i++) {
    if (!this->random_reward(i).IsInitialized()) return false;
  }
  return true;
}
...
bool ProductLine::IsInitialized() const {
  ...
  for (int i = 0; i < equipline_size(); i++) {
    if (!this->equipline(i).IsInitialized()) return false;
  }
  for (int i = 0; i < animal_line_size(); i++) {
    if (!this->animal_line(i).IsInitialized()) return false;
  }
  if (has_get_storage_material()) {
    if (!this->get_storage_material().IsInitialized()) return false;
  }
  for (int i = 0; i < fruit_line_size(); i++) {
    if (!this->fruit_line(i).IsInitialized()) return false;
  }
  if (has_aid_reward()) {
