...
const BuildFoot& BuildFoot::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ConfigBuilding_2eproto();  return *default_instance_;
}
...
bool StorageHouse::IsInitialized() const {
  ...
  for (int i = 0; i < need_cost_size(); i++) {
    if (!this->need_cost(i).IsInitialized()) return false;
  }
  return true;
}
...
bool ProduceEquipment::IsInitialized() const {
  ...
  for (int i = 0; i < upgrade_star_size(); i++) {
    if (!this->upgrade_star(i).IsInitialized()) return false;
  }
  if (has_build_reward()) {
    if (!this->build_reward().IsInitialized()) return false;
  }
...
bool Buildings::IsInitialized() const {
  ...
  for (int i = 0; i < storagehouse_size(); i++) {
    if (!this->storagehouse(i).IsInitialized()) return false;
  }
  for (int i = 0; i < cropland_size(); i++) {
    if (!this->cropland(i).IsInitialized()) return false;
  }
  for (int i = 0; i < animal_residence_size(); i++) {
    if (!this->animal_residence(i).IsInitialized()) return false;
  }
  for (int i = 0; i < produce_equipment_size(); i++) {
    if (!this->produce_equipment(i).IsInitialized()) return false;
  }
  for (int i = 0; i < fruit_tree_size(); i++) {
    if (!this->fruit_tree(i).IsInitialized()) return false;
  }
  for (int i = 0; i < decorate_size(); i++) {
    if (!this->decorate(i).IsInitialized()) return false;
  }
  for (int i = 0; i < build_print_size(); i++) {
    if (!this->build_print(i).IsInitialized()) return false;
  }
  for (int i = 0; i < animal_size(); i++) {
    if (!this->animal(i).IsInitialized()) return false;
  }
  if (has_view_ad_cfg()) {
...
bool Barriers::IsInitialized() const {
  ...
  for (int i = 0; i < barriers_size(); i++) {
    if (!this->barriers(i).IsInitialized()) return false;
  }
  for (int i = 0; i < barriers_destory_size(); i++) {
    if (!this->barriers_destory(i).IsInitialized()) return false;
  }
  return true;
}
