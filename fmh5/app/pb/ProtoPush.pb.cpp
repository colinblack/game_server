...
bool PushBuildingsCPP::IsInitialized() const {
  ...
  for (int i = 0; i < croplands_size(); i++) {
    if (!this->croplands(i).IsInitialized()) return false;
  }
  ...
  for (int i = 0; i < equipmentstar_size(); i++) {
    if (!this->equipmentstar(i).IsInitialized()) return false;
  }
