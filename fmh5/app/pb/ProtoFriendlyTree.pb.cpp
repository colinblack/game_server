...
const FriendlyTreeBasicCPP& FriendlyTreeBasicCPP::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ProtoFriendlyTree_2eproto();  return *default_instance_;
}
...
void CSWaterFriendlyTreeReq::SharedCtor() {
  ...
  myhead_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  othuid_ = 0u;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void CSWaterFriendlyTreeReq::SharedDtor() {
  ...
  if (myhead_ != &::google::protobuf::internal::kEmptyString) {
    delete myhead_;
  }
  if (this != default_instance_) {
  }
