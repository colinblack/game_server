	...
	else if (action == "finish")
	{
		...
		for(vector<U_L_MAP>::iterator myItr=vecAlliances.begin(); myItr != vecAlliances.end(); myItr++)
		{
			if (myItr->second == 1)
			{
				...
				ret = logicAlliance.ChangeResource(myItr->first, 10000000,10000000,10000000,10000000,0,1000,"ALL_BASEMATCH_CHAMPION");
				if (0 != ret)
				{
			...
			else if (myItr->second == 2)
			{
				...
				ret = logicAlliance.ChangeResource(myItr->first, 8000000,8000000,8000000,8000000,0,800,"ALL_BASEMATCH_TOP2");
				if (0 != ret)
				{
					cout << "ChangeResource fail ret=" << ret << ",aid=" << myItr->first << endl;
				}
			...
			else if (myItr->second == 4)
			{
				...
				ret = logicAlliance.ChangeResource(myItr->first, 5000000,5000000,5000000,5000000,0,500,"ALL_BASEMATCH_TOP4");
				if (0 != ret)
				{
					cout << "ChangeResource fail ret=" << ret << ",aid=" << myItr->first << endl;
				}
			...
			else
			{
				...
				ret = logicAlliance.ChangeResource(myItr->first, 3000000,3000000,3000000,3000000,0,300,"ALL_BASEMATCH_TOP8");
				if (0 != ret)
				{
					cout << "ChangeResource fail ret=" << ret << ",aid=" << myItr->first << endl;
				}
