	...
	else if (action == "finish")
	{
		...
		for(vector<U_L_MAP>::iterator myItr=vecAlliances.begin(); myItr != vecAlliances.end(); myItr++)
		{
			if (myItr->second == 1)
			{
				...
				ret = logicAlliance.ChangeResource(myItr->first, 1500000,1500000,1500000,1500000,0,150,"BASEMATCH_CHAMPION");
				if (0 != ret)
				{
			...
			else if (myItr->second == 2)
			{
				...
				CLogicAlliance logicAlliance;
				ret = logicAlliance.ChangeResource(myItr->first, 1300000,1300000,1300000,1300000,0,130,"BASEMATCH_TOP2");
				if (0 != ret)
				{
					cout << "ChangeResource fail ret=" << ret << ",aid=" << myItr->first << endl;
				}
			...
			else if (myItr->second == 4)
			{
				...
				CLogicAlliance logicAlliance;
				ret = logicAlliance.ChangeResource(myItr->first, 1000000,1000000,1000000,1000000,0,100,"BASEMATCH_TOP4");
				if (0 != ret)
				{
					cout << "ChangeResource fail ret=" << ret << ",aid=" << myItr->first << endl;
				}
			...
			else //if (myItr->second == 8)
			{
				...
				CLogicAlliance logicAlliance;
				ret = logicAlliance.ChangeResource(myItr->first, 800000,800000,800000,800000,0,80,"BASEMATCH_TOP8");
				if (0 != ret)
				{
					cout << "ChangeResource fail ret=" << ret << ",aid=" << myItr->first << endl;
				}
