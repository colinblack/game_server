package com.sanguo.game.server.connectlogic.common.message.ProtoFriendlyTree
{
	...
	public class PushFriendlyTreeMsg
	{
		public static const PROTO:String = "ProtoFriendlyTree.PushFriendlyTreeMsg";
		public var package_root:*;
		public  var message:*;
		public var basictreeinfo:Vector.<FriendlyTreeBasicCPP>;
		public var statustreeinfo:FriendlyTreeStatusCPP;
		public function PushFriendlyTreeMsg(root:*)
		{
			package_root = root;
		...
		public function unserialize(msgObj:*):PushFriendlyTreeMsg
		{
			basictreeinfo = new Vector.<FriendlyTreeBasicCPP>();
			statustreeinfo = undefined;
		...
		public function decode(buffer:*):PushFriendlyTreeMsg
		{
