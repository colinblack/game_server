package com.sanguo.game.server.connectlogic.common.message.ProtoPet
{
	...
	public class TeasePetResp
	{
		public static const PROTO:String = "ProtoPet.TeasePetResp";
		public var package_root:*;
		public  var message:*;
		public var pet:UnlockPetCPP;
		public var common:CommonItemsCPP;
		public var reward:CommonItemsCPP;
		public function TeasePetResp(root:*)
		{
			package_root = root;
		...
		public function unserialize(msgObj:*):TeasePetResp
		{
			pet = undefined;
			common = undefined;
			reward = undefined;
		...
		public function decode(buffer:*):TeasePetResp
		{
