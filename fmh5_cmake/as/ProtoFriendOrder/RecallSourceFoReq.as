package com.sanguo.game.server.connectlogic.common.message.ProtoFriendOrder
{
	...
	public class RecallSourceFoReq
	{
		public static const PROTO:String = "ProtoFriendOrder.RecallSourceFoReq";
		...
		public function RecallSourceFoReq(root:*)
		{
			package_root = root;
		...
		public function unserialize(msgObj:*):RecallSourceFoReq
		{
			myuid = undefined;
			myindex = undefined;
			sourceId = undefined;
		...
		public function decode(buffer:*):RecallSourceFoReq
		{
