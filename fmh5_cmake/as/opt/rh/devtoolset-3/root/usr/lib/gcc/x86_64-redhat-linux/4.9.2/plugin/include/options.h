...
enum opt_code
{
  ...
  OPT_frtti = 844,                           /* -frtti */
  OPT_fsanitize_recover = 845,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 846,              /* -fsanitize-recover= */
  ...
  OPT_mbionic = 1100,                        /* -mbionic */
  OPT_mbmi = 1101,                           /* -mbmi */
  OPT_mbmi2 = 1102,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1103,                  /* -mbranch-cost= */
  OPT_mcld = 1104,                           /* -mcld */
  OPT_mcmodel_ = 1105,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1106, */                    /* -mcpu= */
  ...
  OPT_mpopcnt = 1152,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1153,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1154,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1155,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1156,                        /* -mprfchw */
  OPT_mpush_args = 1157,                     /* -mpush-args */
  OPT_mrdrnd = 1158,                         /* -mrdrnd */
  OPT_mrdseed = 1159,                        /* -mrdseed */
  OPT_mrecip = 1160,                         /* -mrecip */
  OPT_mrecip_ = 1161,                        /* -mrecip= */
  OPT_mred_zone = 1162,                      /* -mred-zone */
  OPT_mregparm_ = 1163,                      /* -mregparm= */
  OPT_mrtd = 1164,                           /* -mrtd */
  OPT_mrtm = 1165,                           /* -mrtm */
  OPT_msahf = 1166,                          /* -msahf */
  OPT_msha = 1167,                           /* -msha */
  OPT_mskip_rax_setup = 1168,                /* -mskip-rax-setup */
  ...
  OPT_mtls_direct_seg_refs = 1187,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1188,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1189,                         /* -mtune= */
  OPT_muclibc = 1190,                        /* -muclibc */
  OPT_mveclibabi_ = 1191,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1192,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1193,                    /* -mvzeroupper */
  OPT_mx32 = 1194,                           /* -mx32 */
  OPT_mxop = 1195,                           /* -mxop */
  OPT_mxsave = 1196,                         /* -mxsave */
  OPT_mxsaveopt = 1197,                      /* -mxsaveopt */
  OPT_n = 1198,                              /* -n */
  OPT_no_canonical_prefixes = 1199,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1200,              /* -no-integrated-cpp */
  OPT_nocpp = 1201,                          /* -nocpp */
  OPT_nodefaultlibs = 1202,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1203,                   /* -nostartfiles */
  OPT_nostdinc = 1204,                       /* -nostdinc */
  OPT_nostdinc__ = 1205,                     /* -nostdinc++ */
  OPT_nostdlib = 1206,                       /* -nostdlib */
  OPT_o = 1207,                              /* -o */
  OPT_p = 1208,                              /* -p */
  OPT_pass_exit_codes = 1209,                /* -pass-exit-codes */
  /* OPT_pedantic = 1210, */                 /* -pedantic */
  OPT_pedantic_errors = 1211,                /* -pedantic-errors */
  OPT_pg = 1212,                             /* -pg */
  OPT_pie = 1213,                            /* -pie */
  OPT_pipe = 1214,                           /* -pipe */
  OPT_posix = 1215,                          /* -posix */
  OPT_print_file_name_ = 1216,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1217,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1218,          /* -print-multi-directory */
  OPT_print_multi_lib = 1219,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1220,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1221,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1222,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1223,               /* -print-prog-name= */
  OPT_print_search_dirs = 1224,              /* -print-search-dirs */
  OPT_print_sysroot = 1225,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1226,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1227,                        /* -profile */
  OPT_pthread = 1228,                        /* -pthread */
  OPT_quiet = 1229,                          /* -quiet */
  OPT_r = 1230,                              /* -r */
  OPT_rdynamic = 1231,                       /* -rdynamic */
  ...
  OPT_std_c__1y = 1255,                      /* -std=c++1y */
  OPT_std_c__98 = 1256,                      /* -std=c++98 */
  OPT_std_c11 = 1257,                        /* -std=c11 */
  /* OPT_std_c1x = 1258, */                  /* -std=c1x */
  /* OPT_std_c89 = 1259, */                  /* -std=c89 */
  OPT_std_c90 = 1260,                        /* -std=c90 */
  OPT_std_c99 = 1261,                        /* -std=c99 */
  /* OPT_std_c9x = 1262, */                  /* -std=c9x */
  OPT_std_f2003 = 1263,                      /* -std=f2003 */
  OPT_std_f2008 = 1264,                      /* -std=f2008 */
  OPT_std_f2008ts = 1265,                    /* -std=f2008ts */
  OPT_std_f95 = 1266,                        /* -std=f95 */
  OPT_std_gnu = 1267,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1268, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1269, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1270,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1271, */              /* -std=gnu++14 */
