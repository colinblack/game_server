...
#endif
#ifdef GENERATOR_FILE
extern int flag_dec_pad_with_spaces;
#else
  int x_flag_dec_pad_with_spaces;
#define flag_dec_pad_with_spaces global_options.x_flag_dec_pad_with_spaces
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_fdec = 592,                            /* -fdec */
  OPT_fdec_include = 593,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 594,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 595,                       /* -fdec-math */
  OPT_fdec_pad_with_spaces = 596,            /* -fdec-pad-with-spaces */
  ...
  OPT_fpad_source = 871,                     /* -fpad-source */
  ...
  /* OPT_mcet = 1241, */                     /* -mcet */
  OPT_mcet_switch = 1242,                    /* -mcet-switch */
  OPT_mcld = 1243,                           /* -mcld */
  OPT_mclflushopt = 1244,                    /* -mclflushopt */
  OPT_mclwb = 1245,                          /* -mclwb */
  OPT_mclzero = 1246,                        /* -mclzero */
  OPT_mcmodel_ = 1247,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1248, */                    /* -mcpu= */
  ...
  OPT_mglibc = 1268,                         /* -mglibc */
  OPT_mhard_float = 1269,                    /* -mhard-float */
  OPT_mhle = 1270,                           /* -mhle */
  OPT_miamcu = 1271,                         /* -miamcu */
  OPT_mieee_fp = 1272,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1273,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1274,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1275,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1276,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1277,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1278, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1279,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1280,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1281,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1282,                /* -mlong-double-80 */
  OPT_mlwp = 1283,                           /* -mlwp */
  OPT_mlzcnt = 1284,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1285,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1286,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1287,                  /* -mmitigate-rop */
  OPT_mmmx = 1288,                           /* -mmmx */
  OPT_mmovbe = 1289,                         /* -mmovbe */
  OPT_mmovdir64b = 1290,                     /* -mmovdir64b */
  OPT_mmovdiri = 1291,                       /* -mmovdiri */
  OPT_mmpx = 1292,                           /* -mmpx */
  OPT_mms_bitfields = 1293,                  /* -mms-bitfields */
  OPT_mmusl = 1294,                          /* -mmusl */
  OPT_mmwaitx = 1295,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1296,            /* -mno-align-stringops */
  OPT_mno_default = 1297,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1298,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1299,                  /* -mno-push-args */
  OPT_mno_red_zone = 1300,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1301,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1302,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1303,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1304,                          /* -mpc32 */
  OPT_mpc64 = 1305,                          /* -mpc64 */
  OPT_mpc80 = 1306,                          /* -mpc80 */
  OPT_mpclmul = 1307,                        /* -mpclmul */
  OPT_mpcommit = 1308,                       /* -mpcommit */
  OPT_mpconfig = 1309,                       /* -mpconfig */
  OPT_mpku = 1310,                           /* -mpku */
  ...
  OPT_mstv = 1352,                           /* -mstv */
  OPT_mtbm = 1353,                           /* -mtbm */
  OPT_mtls_dialect_ = 1354,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1355,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1356,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1357,                         /* -mtune= */
  OPT_muclibc = 1358,                        /* -muclibc */
  OPT_mvaes = 1359,                          /* -mvaes */
  OPT_mveclibabi_ = 1360,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1361,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1362,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1363,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1364,                      /* -mwbnoinvd */
  OPT_mx32 = 1365,                           /* -mx32 */
  OPT_mxop = 1366,                           /* -mxop */
  OPT_mxsave = 1367,                         /* -mxsave */
  OPT_mxsavec = 1368,                        /* -mxsavec */
  OPT_mxsaveopt = 1369,                      /* -mxsaveopt */
  OPT_mxsaves = 1370,                        /* -mxsaves */
  OPT_n = 1371,                              /* -n */
  OPT_no_canonical_prefixes = 1372,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1373,              /* -no-integrated-cpp */
  OPT_no_pie = 1374,                         /* -no-pie */
  OPT_nocpp = 1375,                          /* -nocpp */
  OPT_nodefaultlibs = 1376,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1377,                   /* -nostartfiles */
  OPT_nostdinc = 1378,                       /* -nostdinc */
  OPT_nostdinc__ = 1379,                     /* -nostdinc++ */
  OPT_nostdlib = 1380,                       /* -nostdlib */
  OPT_o = 1381,                              /* -o */
  OPT_p = 1382,                              /* -p */
  OPT_pass_exit_codes = 1383,                /* -pass-exit-codes */
  /* OPT_pedantic = 1384, */                 /* -pedantic */
  OPT_pedantic_errors = 1385,                /* -pedantic-errors */
  OPT_pg = 1386,                             /* -pg */
  OPT_pie = 1387,                            /* -pie */
  OPT_pipe = 1388,                           /* -pipe */
  OPT_posix = 1389,                          /* -posix */
  OPT_print_file_name_ = 1390,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1391,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1392,          /* -print-multi-directory */
  OPT_print_multi_lib = 1393,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1394,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1395,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1396,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1397,               /* -print-prog-name= */
  OPT_print_search_dirs = 1398,              /* -print-search-dirs */
  OPT_print_sysroot = 1399,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1400,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1401,                        /* -profile */
  OPT_pthread = 1402,                        /* -pthread */
  OPT_quiet = 1403,                          /* -quiet */
  OPT_r = 1404,                              /* -r */
  OPT_rdynamic = 1405,                       /* -rdynamic */
  OPT_remap = 1406,                          /* -remap */
  OPT_s = 1407,                              /* -s */
  OPT_save_temps = 1408,                     /* -save-temps */
  OPT_save_temps_ = 1409,                    /* -save-temps= */
  OPT_shared = 1410,                         /* -shared */
  OPT_shared_libgcc = 1411,                  /* -shared-libgcc */
  /* OPT_specs = 1412, */                    /* -specs */
  OPT_specs_ = 1413,                         /* -specs= */
  OPT_static = 1414,                         /* -static */
  OPT_static_libasan = 1415,                 /* -static-libasan */
  OPT_static_libgcc = 1416,                  /* -static-libgcc */
  OPT_static_libgfortran = 1417,             /* -static-libgfortran */
  OPT_static_libgo = 1418,                   /* -static-libgo */
  OPT_static_liblsan = 1419,                 /* -static-liblsan */
  OPT_static_libmpx = 1420,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1421,          /* -static-libmpxwrappers */
  ...
  /* OPT_std_c89 = 1439, */                  /* -std=c89 */
  OPT_std_c90 = 1440,                        /* -std=c90 */
  OPT_std_c99 = 1441,                        /* -std=c99 */
  /* OPT_std_c9x = 1442, */                  /* -std=c9x */
  OPT_std_extra_legacy = 1443,               /* -std=extra-legacy */
  ...
  /* OPT_std_gnu89 = 1463, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1464,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1465,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1466, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1467, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1468,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1469, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1470, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1471, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1472, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1473, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1474,                     /* -std=legacy */
  OPT_symbolic = 1475,                       /* -symbolic */
  OPT_t = 1476,                              /* -t */
  OPT_time = 1477,                           /* -time */
  OPT_time_ = 1478,                          /* -time= */
  OPT_tno_android_cc = 1479,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1480,                 /* -tno-android-ld */
