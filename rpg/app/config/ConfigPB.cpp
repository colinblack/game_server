			...
			if (json.isArray()) {
				for (unsigned j = 0; j < json.size(); ++j) {
					...
					case FieldDescriptor::CPPTYPE_DOUBLE:
						ref->AddDouble(msg, field, json[j].asDouble());
						break;
					case FieldDescriptor::CPPTYPE_FLOAT:
						ref->AddFloat(msg, field, (float) json[j].asDouble());
						break;
					case FieldDescriptor::CPPTYPE_INT64:
						ref->AddInt64(msg, field, (int64_t) json[j].asDouble());
						break;
					case FieldDescriptor::CPPTYPE_UINT64:
						ref->AddUInt64(msg, field, (uint64_t) json[j].asDouble());
						break;
					case FieldDescriptor::CPPTYPE_INT32:
						ref->AddInt32(msg, field, json[j].asInt());
						break;
					case FieldDescriptor::CPPTYPE_UINT32:
						ref->AddUInt32(msg, field, json[j].asUInt());
						break;
					case FieldDescriptor::CPPTYPE_BOOL:
						ref->AddBool(msg, field, json[j].asBool());
						break;
					case FieldDescriptor::CPPTYPE_STRING:
						ref->AddString(msg, field, json[j].asString());
						break;
					case FieldDescriptor::CPPTYPE_MESSAGE:
						if (!_j2p(ref->AddMessage(msg, field), json[j]))
							return false;
						break;
					default:
						break;
