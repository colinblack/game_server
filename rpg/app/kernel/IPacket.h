...
#define PACKET_ENCODE_BEGIN(buff) if (buff == NULL) return false; CBufferWriter writer(buff)
...
#define PACKET_DECODE_BEGIN(buff) if (buff == NULL) return false; CBufferReader reader(buff)
