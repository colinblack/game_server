...
CDataAllServerBaseMatch::CDataAllServerBaseMatch()
{
	m_init = false;
}

int CDataAllServerBaseMatch::Init(const string &path, semdat sem)
{
	if(m_init)
	{
		return 0;
	...
	if (path.empty())
	{
		error_log("[init_all_server_basematch_fail][path=%s]", path.c_str());
		return R_ERROR;
	}
	int semgroup = 0;
	int semserver = 0;
	...
	if(!m_sh.CreateOrOpen(path.c_str(), sizeof(AllServerBaseMatchData), SEM_ID(sem,semgroup,semserver)))
	{
		error_log("[init_all_server_basematch_fail][path=%s]", path.c_str());
		return R_ERROR;
	}
...
int CDataAllServerBaseMatch::View(unsigned aid, unsigned uid, int &stage, BaseMatchTeam &team, BaseMatchRegularRival &rival,
...
int CDataAllServerBaseMatch::Apply(unsigned aid, const string &aname,
		int flag, unsigned uid, const string &name, unsigned &instanceid,bool allserver)
{
	...
	{
		if (pdata->numOfApply >= ALL_SERVER_BASEMATCH_TEAMS_MAX)
		{
...
int CDataAllServerBaseMatch::ReportResult(unsigned uid, int order, int damage)
{
...
int CDataAllServerBaseMatch::StartRegular()
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::StartGuess(bool allserver)
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::StartPlayoff8()
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::StartPlayoff4(bool allserver)
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::StartPlayoff2(bool allserver)
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::FinishMatch(const AllServerBaseMatchData **p,bool allserver)
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::NextTurn()
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::IsBaseMatchProtect(unsigned aid, unsigned uid, bool &prot)
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::GetApplyPlayersOfTeam(unsigned aid, vector<BaseMatchPlayer> &players)
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
int CDataAllServerBaseMatch::GetRegularScore(unsigned aid, unsigned &damage, unsigned &rank, vector<BaseMatchRegularRival> &players)
{
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
...
AllServerBaseMatchData * CDataAllServerBaseMatch::GetMatchData(){
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	return pdata;
}

int CDataAllServerBaseMatch::GetStage(int& stage){
	AllServerBaseMatchData *pdata = (AllServerBaseMatchData *)m_sh.GetAddress();
	if(pdata == NULL)
	{
		error_log("[GetAddress fail][]");
