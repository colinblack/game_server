...
//autolable2
CONFIG_yongguansanjun,
CONFIG_wuyiqingdian_leiji,
CONFIG_yvre618_2,
CONFIG_yvre618_1,
CONFIG_toushichejineng,
CONFIG_chongbang_3,
CONFIG_zhuanshucanjuan,
CONFIG_baihuahuikui_3,
CONFIG_baihuahuikui_2,
CONFIG_baihuahuikui_1,
CONFIG_guyv_leiji,
CONFIG_chengyuantisheng,
CONFIG_lueduotongqian_chongbang,
	   CONFIG_anniversary_chongzhi,
CONFIG_zhengbashadi_chongbang,
...
CONFIG_double11_2018,
	   ...
	   CONFIG_ZHOUNIANQING_QIANDAO,
	   CONFIG_ZHOUNIANQING_GOUMAI,
	   ACTIVITY_TIME_TOUZIDAFANLI,
	   ACTIVITY_TIME_GUYU,
	   ACTIVITY_TIME_ERTONGJIE,
	   ACTIVITY_TIME_STONE,  
	   ACTIVITY_TIME_OLDTONEW,
	   ACTIVITY_TIME_wuyiqingdian,
	   CONFIG_ROTARYTABLEFEEDBACK_GIFT,
	   CONFIG_GIVEHELPACTION,
	   ACTIVITY_TIME_QUNXING,
	   ACTIVITY_TIME_QITIANJINJIE,
       NULL
};
