...
class DBCSimpleTemplate
	 : public DataSingleton<_DBC, _ID , DB_BASE_BUFF*DB_BASE_FULL, _HANDLE, DB_BASE_FULL>
{
	 typedef DataSingleton<_DBC, _ID , DB_BASE_BUFF*DB_BASE_FULL, _HANDLE, DB_BASE_FULL> base;
protected:
	 int FreeIndex()
	 {
...
public:
	...
	int LoadBuffer(unsigned uid)
	{
		...
		{
			throw std::runtime_error("already_load_data");
		}
