package DataCommon {
	...
	public dynamic final class EquipmentAllCPP extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const EQUIPS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("DataCommon.EquipmentAllCPP.equips", "equips", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return DataCommon.EquipmentCPP; });
