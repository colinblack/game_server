package ProtoPush {
	...
	public dynamic final class BuildYieldInfo extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const YIELD:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("ProtoPush.BuildYieldInfo.yield", "yield", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoBuilding.BuildYield; });
