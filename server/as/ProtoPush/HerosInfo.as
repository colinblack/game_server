package ProtoPush {
	...
	public dynamic final class HerosInfo extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const HEROS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("ProtoPush.HerosInfo.heros", "heros", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoHero.HeroBaseInfoCPP; });
