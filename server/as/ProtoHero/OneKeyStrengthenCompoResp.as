package ProtoHero {
	...
	public dynamic final class OneKeyStrengthenCompoResp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const COMPO:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("ProtoHero.OneKeyStrengthenCompoResp.compo", "compo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoComponent.ComponentCPP; });
		 ...
		 *  @private
		 */
		public static const DELCOMPOS:RepeatedFieldDescriptor_TYPE_UINT32 = new RepeatedFieldDescriptor_TYPE_UINT32("ProtoHero.OneKeyStrengthenCompoResp.delcompos", "delcompos", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COIN:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("ProtoHero.OneKeyStrengthenCompoResp.coin", "coin", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return DataCommon.CostItemCPP; });
		 ...
		 *  @private
		 */
		public static const WOOD:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("ProtoHero.OneKeyStrengthenCompoResp.wood", "wood", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return DataCommon.CostItemCPP; });
		 ...
		 *  @private
		 */
		public static const HERO:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("ProtoHero.OneKeyStrengthenCompoResp.hero", "hero", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoHero.HeroBaseInfoCPP; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (compo$count != 0) {
						throw new flash.errors.IOError('Bad data format: OneKeyStrengthenCompoResp.compo cannot be set twice.');
					}
					++compo$count;
				...
				case 3:
					if (coin$count != 0) {
						throw new flash.errors.IOError('Bad data format: OneKeyStrengthenCompoResp.coin cannot be set twice.');
					}
					++coin$count;
				...
				case 4:
					if (wood$count != 0) {
						throw new flash.errors.IOError('Bad data format: OneKeyStrengthenCompoResp.wood cannot be set twice.');
					}
					++wood$count;
				...
				case 5:
					if (hero$count != 0) {
						throw new flash.errors.IOError('Bad data format: OneKeyStrengthenCompoResp.hero cannot be set twice.');
					}
					++hero$count;
