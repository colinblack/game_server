package ProtoHero {
	...
	public dynamic final class EquipmentWrapCPP extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const EQUIPS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("ProtoHero.EquipmentWrapCPP.equips", "equips", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return DataCommon.EquipmentCPP; });
