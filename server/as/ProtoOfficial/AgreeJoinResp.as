package ProtoOfficial {
	...
	public dynamic final class AgreeJoinResp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const DEPARTMENT:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("ProtoOfficial.AgreeJoinResp.department", "department", (1 << 3) | com.netease.protobuf.WireType.VARINT, ProtoOfficial.eDepartment);
		 ...
		 *  @private
		 */
		public static const MEMBERS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("ProtoOfficial.AgreeJoinResp.members", "members", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoOfficial.DepartmentMember; });
		 ...
		 *  @private
		 */
		public static const RECORDS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("ProtoOfficial.AgreeJoinResp.records", "records", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoOfficial.DepartmentRecord; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (department$count != 0) {
						throw new flash.errors.IOError('Bad data format: AgreeJoinResp.department cannot be set twice.');
					}
					++department$count;
