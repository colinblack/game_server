package ProtoOfficial {
	...
	public dynamic final class GetDepartmentRecordResp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RECORDS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("ProtoOfficial.GetDepartmentRecordResp.records", "records", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoOfficial.DepartmentRecord; });
