package ProtoOfficial {
	...
	public dynamic final class PkCaptainResp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const DEPARTMENT:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("ProtoOfficial.PkCaptainResp.department", "department", (1 << 3) | com.netease.protobuf.WireType.VARINT, ProtoOfficial.eDepartment);
		 ...
		 *  @private
		 */
		public static const CAPTAIN:FieldDescriptor_TYPE_UINT32 = new FieldDescriptor_TYPE_UINT32("ProtoOfficial.PkCaptainResp.captain", "captain", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const HERO_IDS:RepeatedFieldDescriptor_TYPE_UINT32 = new RepeatedFieldDescriptor_TYPE_UINT32("ProtoOfficial.PkCaptainResp.hero_ids", "heroIds", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const HERO_LVL:RepeatedFieldDescriptor_TYPE_UINT32 = new RepeatedFieldDescriptor_TYPE_UINT32("ProtoOfficial.PkCaptainResp.hero_lvl", "heroLvl", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const HERO_TROOPS:RepeatedFieldDescriptor_TYPE_UINT32 = new RepeatedFieldDescriptor_TYPE_UINT32("ProtoOfficial.PkCaptainResp.hero_troops", "heroTroops", (5 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (department$count != 0) {
						throw new flash.errors.IOError('Bad data format: PkCaptainResp.department cannot be set twice.');
					}
					++department$count;
				...
				case 2:
					if (captain$count != 0) {
						throw new flash.errors.IOError('Bad data format: PkCaptainResp.captain cannot be set twice.');
					}
					++captain$count;
