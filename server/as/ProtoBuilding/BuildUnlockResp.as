package ProtoBuilding {
	...
	public dynamic final class BuildUnlockResp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const BUILD_QUEUE:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("ProtoBuilding.BuildUnlockResp.build_queue", "buildQueue", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoBuilding.BuildQueue; });
		 ...
		 *  @private
		 */
		public static const BUILDS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("ProtoBuilding.BuildUnlockResp.builds", "builds", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return ProtoBuilding.BuildInfo; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (build_queue$count != 0) {
						throw new flash.errors.IOError('Bad data format: BuildUnlockResp.buildQueue cannot be set twice.');
					}
					++build_queue$count;
