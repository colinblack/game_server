...
public:
	...
	virtual PlatformType GetPlatformType() { return PT_FACEBOOK; }
	...
	int SetScore(const string &openid, const string &openkey, uint64_t score);
	int SetAchievement(const string &openid, const string &openkey, const string &achievementId);
