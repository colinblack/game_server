...
int CDataAttack::AddAttack(DataAttack &attack)
{
	...
	DBCREQ_SET_INT(attack, defence_baseid);
	...
	DBCREQ_SET_STR(attack, defence_base_name);
...
int CDataAttack::GetAttack(uint64_t attack_id, DataAttack &attack)
{
	...
	DBCREQ_GET_INT(attack, defence_baseid);
	...
	DBCREQ_GET_STR(attack, defence_base_name);
